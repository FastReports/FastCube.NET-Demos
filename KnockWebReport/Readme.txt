Before you can work with this application, you must install the SPA templates. 
This can be done by using the command in the console: dotnet new --install Microsoft.AspNetCore.SpaTemplates::2.0.7
